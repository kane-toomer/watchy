...
// };
const navigation = [
	{ name: "Buy a Watch", href: "#", current: true },
	{ name: "Sell a Watch", href: "#", current: false },
	{ name: "Magazine", href: "#", current: false },
	{ name: "FAQ", href: "#", current: false },
	{ name: "Buyer Protection", href: "#", current: false },
];
					...
					<div className="mx-auto max-w-7xl px-2 sm:px-4 lg:divide-y lg:divide-gray-200 lg:px-8">
						<div className="relative flex h-16 justify-between">
							...
							<div className="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
								<a
									href="#"
									className="relative flex-shrink-0 rounded-full bg-white p-1 text-gray-900 hover:text-gray-500 focus:outline-none">
									Login
								</a>
								<a
									href="#"
